...
선별된 Split, Outage, Recipe Switch, Distance Switch의 8개 layout에 대해
seed `0..2`를 학습한다. Population sweep은 총 24 runs다.
...
Population sweep을 모두 마친 뒤 실행한다. 동일한 8개 layout에 대해 FCP
best-response seed `0..5`, 총 48 runs를 학습한다.
