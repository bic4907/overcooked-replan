...
전환 예고의 기여를 별도로 확인했다. 경고가 보일 때는 SP 240, XP 227.33;
경고를 숨기면 SP 226, XP 216.44였다. 경고는 두 조합의 절대 점수에
기여했지만, 경고가 없어도 SP–XP 차이 9.56점은 남았다. 따라서 경고를
활용한 사전 적응만이 XP 손실의 원인이라고 해석해서는 안 된다. FCP
4시드에서는 SP와 XP가 모두 220점이었고 관습 불일치 효과가 나타나지 않았다.
