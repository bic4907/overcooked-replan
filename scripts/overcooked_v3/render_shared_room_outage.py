"""Render shared-room outage layouts with the native V3 visualizer."""
...
WIDE_LAYOUT_ROWS = (("outage_wide_2",), ("outage_wide_2_plate",))
PHASES = (("Phase A", 0), ("Phase B", 1))


def parse_args():
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--wide", action="store_true", help="Render the two shared-room wide maps")
...
def main():
    ...
    if args.output_dir is None:
        args.output_dir = Path(
            "docs/overcooked_v3/shared_room_outage"
        )
    if args.tile_size < 8:
    ...
    output_path = args.output_dir / (
        ...
        "wide_layouts_2.png" if args.wide else "layout_candidates.png"
    )
